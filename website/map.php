...
<html lang="en">
	...
	<body>
      ...
      <?php include './assets/partials/navbar.php'; ?>
			...
			<!-- BODY -->
			<div class="map-container Montserrat-Regular">
				...
				<h1 class="center-text">MAPA GEOTERRA</h1>

				<div class="map Montserrat-Regular" id="map"> MAP
					<!--LEAFLET JS-->
          			<script src="https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.6.2/proj4.js" defer></script>
					<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" defer></script>
					<script src="./assets/js/interactive-map.js" defer></script>
				</div>
