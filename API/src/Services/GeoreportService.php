...
final class GeoreportService
{
   ...
   * @throws ApiException
   */
  private function validateTestsExist(
    string $insituTestId,
    string $inlabTestId
  ): void {
  ...
  public function create(GeoreportDTO $dto, bool $setAsCurrent = true): void
  {
    ...
    if ($setAsCurrent) {
      ...
      if (!$updated) {
        ...
        throw new ApiException(
          ErrorType::internal('Failed to set as current georeport'),
          500
        );
      }
    }
  ...
  public function update(
    ...
    if (!$updated) {
      throw new ApiException(
        ErrorType::internal('Failed to update georeport'),
        500
      );
    }
