...
fun HomeContent(
    ...
    Column(
        ...
        StepItem(1, "Recolección de datos", "GeoterRA comienza con la recolección integral de datos geológicos de diversas fuentes.")
        StepItem(2, "Validación y almacenamiento", "Los datos pasan por un riguroso proceso de validación y se almacenan en SQL.")
        StepItem(3, "Herramientas avanzadas", "Visualización 3D y mapas interactivos para planificación estratégica.")
