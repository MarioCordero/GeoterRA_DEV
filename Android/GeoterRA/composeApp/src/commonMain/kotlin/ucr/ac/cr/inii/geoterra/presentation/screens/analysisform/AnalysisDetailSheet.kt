...
fun AnalysisDetailSheet(request: AnalysisRequestRemote) {
    Column(
        ...
        Text(request.name, style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.Bold)
        Text("Creado el: ${request.created_at}", style = MaterialTheme.typography.labelSmall, color = Color.Gray)
        ...
        if (!request.details.isNullOrBlank()) {
            ...
            Text("Detalles adicionales:", fontWeight = FontWeight.Bold, style = MaterialTheme.typography.bodyLarge)
