...
class LoginActivity : AppCompatActivity(), OnFragmentInteractionListener {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.loginLayout)
    ) { v, insets ->
      val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
      v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
      insets
    }
    this.rootView = findViewById(R.id.loginLayout)
  ...
  private fun setTogglePasswordClickListener(showPassword : LinearLayout) {
    showPassword.setOnClickListener {
      ...
      val passwordEditText = this.rootView.findViewById<EditText>(R.id.password)
