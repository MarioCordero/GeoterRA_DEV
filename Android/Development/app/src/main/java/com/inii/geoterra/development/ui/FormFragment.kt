...
import com.inii.geoterra.development.LocationService
...
class FormFragment : Fragment() {
  ...
  : View? {
    ...
    locationButton.setOnClickListener { checkAppPermissions() }

    imageLocation.setOnClickListener { openGallery() }
  ...
  private fun checkAppPermissions() {
    if (ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
      ...
      lifecycleScope.launch {
        ...
        Toast.makeText(requireContext(), "Latitud ${result?.latitude}  y longitud ${result?.longitude}", Toast.LENGTH_SHORT).show()
      }
    }
  }
