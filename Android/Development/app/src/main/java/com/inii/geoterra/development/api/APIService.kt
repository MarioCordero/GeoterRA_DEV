...
//  @SerializedName("coord_x") val latitude: Double = 0.0,
//  @SerializedName("coord_y") val longitude: Double = 0.0,
//  @SerializedName("direccion") val address: String = "",
//  @SerializedName("uso_actual") val currentUsage: String = "",
//  @SerializedName("sens_termica") val thermalSensation: Int = 0,
//  @SerializedName("burbujeo") val bubbles: Int = 0,
